const initialState = [
  {
    name: "Char",
    imgUrl:
      "https://ewscripps.brightspotcdn.com/dims4/default/f70897b/2147483647/strip/true/crop/508x286+66+0/resize/1280x720!/quality/90/?url=https%3A%2F%2Fmediaassets.ktnv.com%2Fphoto%2F2017%2F08%2F15%2Fhusky3_1502798898905_64205695_ver1.0_640_480.JPG",
    sex: "Male",
    age: 3,
    location: "NYC",
    price: 69,
...
const petStore = (state = initialState, action) => {
  switch (action.type) {
    case "REMOVE_PET_FROM_CATALOGUE":
      return [...action.payload];

    case "ADD_PET_TO_CATALOGUE":
